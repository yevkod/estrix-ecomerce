  ...
  return (
    <div className="flex flex-col min-h-screen rounded-lg text-white bg-gray-800 w-full p-8">
      {productsBasket?.length === 0 ? (
        ...
        <div>
          <div className="flex justify-between border-b-2 p-3 mt-10 pt-3 border-gray-500">
          ...
          <div className="flex flex-col gap-5 pt-5">
            {productsBasket.length !== 0 &&
              productsBasket?.map((product: Product) => (
                <div className="flex rounded-lg bg-gray-500 gap-5 p-3 hover:scale-105 cursor-pointer transition-all items-center justify-between" onClick={() => handleNavigateToProduct(product)}>
